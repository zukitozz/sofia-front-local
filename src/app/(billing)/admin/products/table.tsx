...
export const ProductTable = ({ page, perPage, keyword }: TableProps) => {
    ...
    if(!data || isLoading || isValidating || error || !Array.isArray(data.products) || !Array.isArray(data.pageNumbers)){
